...
class MasterProdukView extends StatefulWidget {
  @override
  _MasterProdukViewState createState() => _MasterProdukViewState();
}

class _MasterProdukViewState extends State<MasterProdukView> {
  final MasterProdukController _controller = Get.put(MasterProdukController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: "Master Produk"),
      body: Column(
        children: [
          Padding(
